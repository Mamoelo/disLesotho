...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function applyPermissionFilters() {
    ...
    const canRemove = JSON.parse(
      localStorage.getItem("canRemoveContent") || "false"
    );
    const canStream = JSON.parse(
      localStorage.getItem("canStartStream") || "false"
    );
    const canSchedule = JSON.parse(
      localStorage.getItem("canSetSchedule") || "false"
    );
    const canManage = JSON.parse(
      localStorage.getItem("canManageUsers") || "false"
    );
